\begin{abstract}
  ...
  causing fast battery drainage.  This paper presents {\em Smart
    Sensors}\/, a new approach that offloads the periodic sensing
  ...
  interest occurs.  Smart sensors differ from other heterogeneous
  ...
  algorithms and tuning their parameters.  Smart sensors achieve
